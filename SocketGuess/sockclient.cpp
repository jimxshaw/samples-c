...
int main(int argc, char *argv[])
{
    ...
    try
    {
        ...
        {
            throw domain_error(LineInfo("Socket create failure", __FILE__, __LINE__));
        }
        ...
        // Prompt for a guess number in the range
        cout << endl
             << endl
             << "Try to guess a number between 1 and " << MAX_GUESS_LIMIT << endl
             << endl;
